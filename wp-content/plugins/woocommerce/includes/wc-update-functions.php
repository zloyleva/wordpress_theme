...
function wc_update_230_options() {
	...
	// To prevent taxes being hidden when using a default 'no address' in a store with tax Classes prices, set the woocommerce_default_customer_address to use the store base address by default
